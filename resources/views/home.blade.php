...
h2 {
    font-family: "Roboto Slab", Italic Bold;
    font-size: 1.4rem;
    color: black;
    margin: 0 0 8px 0;
}
...
body {
    margin: 0;
    padding: 0;
    background-image: url('assets/images/blog-background.jpg'); /* Define your gradient colors */
...
.pagination-navbar {
    ...
    background-color: #e0b67f; /* Navbar background color */
...
<body>
    <div class="navbar" style="display: flex; justify-content: space-between; align-items: center; padding: 10px; background-color: #794700;">
        
        <div id="nav-header" style="display: flex; align-items: center;">
            <img src="{{ asset('assets/images/coff.jpeg') }}" alt="" style="width: 100px; height: auto;"> 
         <a href="{{ route('home') }}" style="color: rgb(255, 255, 255); text-decoration: none; margin-right: 10px; font-size: 20px" class="ml-3">SITE BLOGS</a>
          
          <a href="{{ route('blogs.index') }}" style="color: rgb(255, 255, 255); text-decoration: none; margin-left: 50px; font-size: 15px">BLOGS</a>
          <a style="margin-left: 900px; font-size:20px;"> 
            <form id="logout-form" action="{{ route('logout') }}" method="POST" class="nav-button" style="cursor: pointer;" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
              ...
              <span style="color: rgb(255, 255, 255); " class="mt-3 ml-5">Logout</span>
            </form>
          </a>
        </div>
    </div>   
