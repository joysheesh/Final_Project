...
<body>
<div class="navbar" style="display: flex; justify-content: space-between; align-items: center; padding: 15x; background-color:  #794700;">
  <div id="nav-header" style="display: flex; align-items: center;">
    <img src="{{ url('assets/images/coff.jpeg') }}" alt="" style="width: 80px; height: auto;"> 
    <a id="nav-title"  target="_blank" style="color: rgb(255, 255, 255);; text-decoration: none; font-size: 24px; margin-right: 20px;"><i class="fab fa-codepen"></i>ALL ABOUT COFFEE</a>
  ...
  <div id="nav-auth" style="display: flex; align-items: center;">
    <a href="{{ route('login') }}" style="color: rgb(255, 255, 255);; text-decoration: none; margin-right: 10px;">Login</a>
    <a href="{{ route('register') }}" style="color: rgb(255, 255, 255);; text-decoration: none;">Register</a>
  </div>
</div>
