...
<head>
 ...
 body {
    margin: 0;
    padding: 0;
    background-image: url("assets/images/whitebg.jpg"); /* Define your gradient colors */
...
.btn-minimalistic:hover {
    color: #ac605d; /* Slight color change on hover */
}
.btn-edit {
...
<body>
    <div class="navbar" style="display: flex; justify-content: space-between; align-items: center; padding: 10px; background-color: #bebebe;">
        ...
        <div id="nav-header" style="display: flex; align-items: center;">
            <img src="{{ asset('assets/images/coff.jpeg') }}" alt="" style="width: 60px; height: auto;"> 
         <a href="{{ route('home') }}" style="color: rgb(11, 11, 11); text-decoration: none; margin-right: 10px; font-size: 20px" class="ml-3">SITE BLOGS</a>
          <a href="{{ route('home') }}" style="color: rgb(11, 11, 11); text-decoration: none; margin-left: 50px; font-size: 15px">DASHBOARD</a>
